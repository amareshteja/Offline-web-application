...
(function () {
    ...
    app.updateForecastCard = function (data) {
        ...
        var dataElm = card.querySelector('.date');
        if (dataElm.getAttribute('data-dt') >= data.currently.time) {
            return;
        }
        dataElm.setAttribute('data-dt',data.currently.time);
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/service_worker.js').then(
            function (registration) {
                console.log('Serice worker registered', registration);
            });
    }
